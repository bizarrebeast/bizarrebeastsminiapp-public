...
export const defaultTemplates: ContestTemplate[] = [
  ...
  },
  {
    ...
    category: 'creative',
    description: 'Community-voted competitive meme contest - top vote-getters win',
    formData: {
      type: 'creative',
      description: 'Create the funniest BizarreBeasts meme! Community votes decide the winner. Top 3 memes with most votes win prizes!',
      min_bb_required: '0',
      prize_amount: '50000000000000000000',
      prize_type: 'tokens',
      max_entries_per_wallet: '3',
      rules: '• Use BizarreBeasts stickers or themes\n• Keep it fun and appropriate\n• Up to 3 submissions per wallet\n• Community votes determine winners\n• Top vote-getters win (admin confirms final selection)\n• Minimum 5 votes required to be eligible',
      is_recurring: false,
      voting_enabled: true,
      voting_type: 'single',
