-- BizarreBeasts Contest System Database Schema
...
-- INSERT INTO contests (name, description, type, min_bb_required, prize_amount, status, start_date, end_date)
-- VALUES
-- ('Treasure Quest High Score Challenge', 'Compete for the highest score in Treasure Quest!', 'game_score', 1000, 10000000, 'active', NOW(), NOW() + INTERVAL '7 days');
