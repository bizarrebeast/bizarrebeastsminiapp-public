...
export default function GamesPage() {
  ...
  const handleGameClick = (url: string, e: React.MouseEvent) => {
    if (isInMiniApp) {
      // If in miniapp, prevent default and use SDK to open URL externally
      e.preventDefault();
                  ...
                  <div className="flex flex-wrap gap-2 mb-4">
                    {game.platforms.farcaster && (
                      <a
                        ...
                        onClick={(e) => handleGameClick(game.platforms.farcaster!, e)}
                    ...
                    {game.platforms.telegram && (
                      <a
                        ...
                        target="_blank"
                        rel="noopener noreferrer"
                        onClick={(e) => handleGameClick(game.platforms.telegram!, e)}
                    ...
                    {game.platforms.worldApp && (
                      <a
                        ...
                        target="_blank"
                        rel="noopener noreferrer"
                        onClick={(e) => handleGameClick(game.platforms.worldApp!, e)}
